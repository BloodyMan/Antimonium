...
/mob/animal/deer/CreateLimbs()
	...
	limbs_by_key[BP_LEFT_HAND] =  new /obj/item/limb(src,        "left front paw",  'icons/mobs/limbs/_default.dmi',      BP_LEFT_HAND,  BP_LEFT_ARM,  _length = 3, _width = 3, _height = 3)
	limbs_by_key[BP_RIGHT_HAND] = new /obj/item/limb(src,        "right front paw", 'icons/mobs/limbs/_default.dmi',      BP_RIGHT_HAND, BP_RIGHT_ARM, _length = 3, _width = 3, _height = 3)
	...
	limbs_by_key[BP_LEFT_FOOT] =  new /obj/item/limb/stance(src, "left rear paw",   'icons/mobs/limbs/_default.dmi',      BP_LEFT_FOOT,  BP_LEFT_LEG,  _length = 3, _width = 3, _height = 3)
	limbs_by_key[BP_RIGHT_FOOT] = new /obj/item/limb/stance(src, "right rear paw",  'icons/mobs/limbs/_default.dmi',      BP_RIGHT_FOOT, BP_RIGHT_LEG, _length = 3, _width = 3, _height = 3)
